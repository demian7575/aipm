...
import { validateEmail, validateAssigneeEmail, validateTaskAssigneeEmail, validateEmailWithToast } from './email-validation-utility.js';

function runEmailValidationUtilityTests() {
...
runEmailValidationUtilityTests();
