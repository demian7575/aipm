...
echo "🧪 Phase 4: Generated Tests from Acceptance Tests"
echo "=================================================="
...
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  ...
  echo "  ❌ FAIL: AT-CS-DATA-L4-002-01: Create story in DynamoDB"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-007-02: Delete dependency"
  PASSED=$((PASSED + 1))
  record_test_result "8" "AT-CS-API-L4-007-02: Delete dependency" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-007-02: Delete dependency"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-DATA-L4-003-03: Update test"
  PASSED=$((PASSED + 1))
  record_test_result "75" "AT-CS-DATA-L4-003-03: Update test" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-DATA-L4-003-03: Update test"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-008-02: Get document"
  PASSED=$((PASSED + 1))
  record_test_result "10" "AT-CS-API-L4-008-02: Get document" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-008-02: Get document"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-OPS-MON-L4-002-01: Version info returned"
  PASSED=$((PASSED + 1))
  record_test_result "82" "AT-OPS-MON-L4-002-01: Version info returned" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-OPS-MON-L4-002-01: Version info returned"
  FAILED=$((FAILED + 1))
...
# Test 1772282122592: Modal opens with story list when header button clicked (Story #1772282121812) - UI Test
echo "Test 1772282122592: Modal opens with story list when header button clicked"
echo "  ⚠️  SKIP: UI test (requires browser automation)"
SKIPPED=$((SKIPPED + 1))
record_test_result "1772282122592" "Modal opens with story list when header button clicked" "SKIP" "$PHASE" "0"


# Test 1772282121959: Modal closes when user clicks close button or outside modal (Story #1772282121812) - UI Test
echo "Test 1772282121959: Modal closes when user clicks close button or outside modal"
echo "  ⚠️  SKIP: UI test (requires browser automation)"
SKIPPED=$((SKIPPED + 1))
record_test_result "1772282121959" "Modal closes when user clicks close button or outside modal" "SKIP" "$PHASE" "0"
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-OPS-MON-L4-001-01: Health check returns OK"
  PASSED=$((PASSED + 1))
  record_test_result "81" "AT-OPS-MON-L4-001-01: Health check returns OK" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-OPS-MON-L4-001-01: Health check returns OK"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-013-01: Health check"
  PASSED=$((PASSED + 1))
  record_test_result "21" "AT-CS-API-L4-013-01: Health check" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-013-01: Health check"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-011-02: Get template content"
  PASSED=$((PASSED + 1))
  record_test_result "18" "AT-CS-API-L4-011-02: Get template content" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-011-02: Get template content"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-009-02: List PRs for story"
  PASSED=$((PASSED + 1))
  record_test_result "12" "AT-CS-API-L4-009-02: List PRs for story" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-009-02: List PRs for story"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-006-02: List tests for story"
  PASSED=$((PASSED + 1))
  record_test_result "4" "AT-CS-API-L4-006-02: List tests for story" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-006-02: List tests for story"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-011-01: List templates"
  PASSED=$((PASSED + 1))
  record_test_result "17" "AT-CS-API-L4-011-01: List templates" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-011-01: List templates"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-006-04: Delete acceptance test"
  PASSED=$((PASSED + 1))
  record_test_result "6" "AT-CS-API-L4-006-04: Delete acceptance test" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-006-04: Delete acceptance test"
  FAILED=$((FAILED + 1))
...
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status"|"success")'; then
  ...
  echo "  ❌ FAIL: AT-CS-DATA-L4-002-03: Update story"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-DATA-L4-003-01: Create test"
  PASSED=$((PASSED + 1))
  record_test_result "73" "AT-CS-DATA-L4-003-01: Create test" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-DATA-L4-003-01: Create test"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-DATA-L5-003-01: Scan all tests"
  PASSED=$((PASSED + 1))
  record_test_result "78" "AT-CS-DATA-L5-003-01: Scan all tests" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-DATA-L5-003-01: Scan all tests"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-DATA-L5-002-01: Scan all stories"
  PASSED=$((PASSED + 1))
  record_test_result "77" "AT-CS-DATA-L5-002-01: Scan all stories" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-DATA-L5-002-01: Scan all stories"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-006-03: Update acceptance test"
  PASSED=$((PASSED + 1))
  record_test_result "5" "AT-CS-API-L4-006-03: Update acceptance test" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-006-03: Update acceptance test"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-013-02: Version info"
  PASSED=$((PASSED + 1))
  record_test_result "22" "AT-CS-API-L4-013-02: Version info" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-013-02: Version info"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-013-04: RTM matrix"
  PASSED=$((PASSED + 1))
  record_test_result "24" "AT-CS-API-L4-013-04: RTM matrix" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-013-04: RTM matrix"
  FAILED=$((FAILED + 1))
...
DURATION=$((($(date +%s) - START_TIME)))
if echo "$RESPONSE" | grep -qE '(^\[|^\{|"id"|"status")'; then
  echo "  ✅ PASS: AT-CS-API-L4-013-03: Runtime data"
  PASSED=$((PASSED + 1))
  record_test_result "23" "AT-CS-API-L4-013-03: Runtime data" "PASS" "$PHASE" "$DURATION"
else
  echo "  ❌ FAIL: AT-CS-API-L4-013-03: Runtime data"
  FAILED=$((FAILED + 1))
