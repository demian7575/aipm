...
# Test for story 1772097585576: Header button opens modal with story list
if [ "$1" = "1772097585576" ]; then
  echo "Test 18: Story 1772097585576 - Header button opens modal with story list"
