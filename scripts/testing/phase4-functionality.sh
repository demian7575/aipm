...
# Test for Story 1771038293964: Story List Button
if [ "$1" == "1771038293964" ]; then
  echo "Test 1771038293964: Story list button exists"
  ...
  echo "Test 1771038293964: Story list modal handler"
