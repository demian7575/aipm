...
test_updated_user_authentication_with_oauth2() {
    ...
    # Test 2: Priority view button exists in frontend
    if ! grep -q "priority-view-btn" apps/frontend/public/index.html; then
        fail_test "Priority view button not added to UI"
        return 1
    fi
    
    # Test 3: Priority sorting logic exists
