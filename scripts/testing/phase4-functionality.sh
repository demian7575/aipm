...
# Test for story 1772093641519: Header button opens modal with story list
if [ "$1" = "1772093641519" ]; then
  echo "Test 18: Story 1772093641519 - Header button opens modal with story list"
  APP_JS_CONTENT=$(curl -s http://aipm-static-hosting-demo.s3-website-us-east-1.amazonaws.com/app.js)
