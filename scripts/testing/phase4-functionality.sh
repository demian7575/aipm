...
# Test for story 1772101689558: Header button opens modal with story list
if [ "$1" = "1772101689558" ]; then
  echo "Test 18: Story 1772101689558 - Header button opens modal with story list"
