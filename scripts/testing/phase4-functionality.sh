...
# Test for story 1772098417901: Header button opens modal with story list
if [ "$1" = "1772098417901" ]; then
  echo "Test 18: Story 1772098417901 - Header button opens modal with story list"
