...
# Test for story 1772095221664: Header button opens modal with story list
if [ "$1" = "1772095221664" ]; then
  echo "Test 18: Story 1772095221664 - Header button opens modal with story list"
