...
# Test for Story 1771039249271: Story List Button
if [ "$1" == "1771039249271" ]; then
  echo "Test 1771039249271: Story list button exists"
  ...
  echo "Test 1771039249271: Story list modal handler"
