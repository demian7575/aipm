...
# Test for story 1772094583842: Header button opens modal with story list
if [ "$1" = "1772094583842" ]; then
  echo "Test 18: Story 1772094583842 - Header button opens modal with story list"
