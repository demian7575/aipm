...
# Test for Story 1771037735042: Story List Button
if [ "$1" == "1771037735042" ]; then
  echo "Test 1771037735042: Story list button exists"
  ...
  echo "Test 1771037735042: Story list modal handler"
