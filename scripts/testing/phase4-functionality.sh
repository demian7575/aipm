...
# Test for Story 1771134776830: Story List Button
if [ "$1" = "1771134776830" ]; then
  echo "Test 17: Story 1771134776830 - Story List Button"
  
  # Check HTML for story list button
  ...
  # Check app.js for modal function
  APP_JS_CONTENT=$(curl -s http://aipm-static-hosting-demo.s3-website-us-east-1.amazonaws.com/app.js)
