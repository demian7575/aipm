...
# Merged: 2026-02-05
# =============================================================================
test_1770264103956_story_list_button() {
    log_test "Story List Button displays all story titles"
    ...
    if ! grep -q 'Stories' apps/frontend/public/index.html; then
        fail_test "Story list button text incorrect"
        return 1
    fi
