...
# Test for story 1772095796124: Header button opens modal with story list
if [ "$1" = "1772095796124" ]; then
  echo "Test 18: Story 1772095796124 - Header button opens modal with story list"
