...
# Test for story list modal button and functionality
if [ "$1" = "1771810269229" ]; then
  echo "Test 17: Story List Modal - Button exists in header"
  ...
  echo "Test 18: Story List Modal - Function implementation"
