...
# Test 48: Story 1771484743533 - Story List Button
if [ "$STORY_ID" = "1771484743533" ]; then
  echo "Test 48: Story 1771484743533 - Story List Button"
  
  # Check button exists in HTML
  if curl -s "$FRONTEND_URL/index.html" | grep -q 'id="story-list-btn"'; then
