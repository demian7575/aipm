...
# Test 45: Story 1771418112824 - Story List Button
if [ "$1" = "1771418112824" ]; then
  echo "Test 45: Story 1771418112824 - Story List Button"
  ...
  # Check JavaScript has event listener
  ...
  if echo "$CSS" | grep -q "#story-list-modal"; then
    echo "  ✅ PASS: Story list modal CSS exists"
    PASSED=$((PASSED + 1))
  else
    echo "  ❌ FAIL: Story list modal CSS missing"
    FAILED=$((FAILED + 1))
  fi
  echo ""
fi
