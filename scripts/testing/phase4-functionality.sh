...
# Test for story 1772097919165: Header button opens modal with story list
if [ "$1" = "1772097919165" ]; then
  echo "Test 18: Story 1772097919165 - Header button opens modal with story list"
