...
if [ -n "$1" ]; then
  ...
  # Story 1771050408416, 1771051431021, 1771053167100, 1771053556695: Add Story List Button
  if [ "$STORY_ID" == "1771050408416" ] || [ "$STORY_ID" == "1771051431021" ] || [ "$STORY_ID" == "1771053167100" ] || [ "$STORY_ID" == "1771053556695" ]; then
