...
const PROD_CONFIG = {
    api: 'http://44.220.45.57:3000',
    devApi: 'http://44.222.168.46:3000',
    ...
    expectedProdApi: 'http://44.220.45.57:3000',
    expectedDevApi: 'http://44.222.168.46:3000',
    dynamoTables: {
...
async function runProductionTest(testName) {
    switch (testName) {
        ...
        case 'testStoryDraftGeneration':
            // Skip to avoid Kiro CLI enhancements
        ...
        case 'testStoryGeneration':
            // Skip to avoid Kiro CLI enhancements
            return { success: true, message: 'Story generation test skipped' };
