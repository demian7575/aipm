...
async function handleMergePRRequest(req, res) {
  try {
    ...
    const testResult = spawnSync('node', ['scripts/testing/run-comprehensive-gating-tests.cjs', 'production'], {
      cwd: process.cwd(),
      encoding: 'utf8',
      timeout: 120000
    });
    ...
    sendJson(res, 200, { message: 'PR merged successfully', testOutput: testResult.stdout });
  } catch (error) {
