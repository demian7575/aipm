import { validateEmail, isValidEmail, sanitizeEmail } from './email-validation-pr840.js';

// Comprehensive test suite for enhanced email validation with error handling
function testEmailValidation() {
  console.log('Testing enhanced email validation with error handling for PR #840...');
