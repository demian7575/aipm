 ...
 * Tests that INVEST display is simplified and actionable
 */
...
async function testSimplifiedInvestDisplay() {
  ...
  // Test 3: Analysis info should indicate source
  if (story.analysisInfo) {
    if (!story.analysisInfo.source) {
      throw new Error('Analysis info missing source indicator');
    }
    console.log(`✓ Analysis source indicated: ${story.analysisInfo.source}`);
  }
