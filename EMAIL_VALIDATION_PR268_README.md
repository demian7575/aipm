# Enhanced Email Validation Utility - PR #268
...
### Basic Validation
```javascript
import { validateEmail, isValidEmail } from './email-validation-pr268.js';
...
### Sanitization
```javascript
import { sanitizeEmail } from './email-validation-pr268.js';
