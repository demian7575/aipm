...
// Test configuration
const TEST_CONFIG = {
  testStoryId: 'test-invest-display-1768066704620',
  testStoryTitle: 'Test Story for INVEST Display',
  testStoryDescription: 'A test story to verify INVEST display simplification',
