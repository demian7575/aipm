# Enhanced Email Validation Utility - PR #840
...
### Basic Validation
```javascript
import { validateEmail, isValidEmail } from './email-validation-pr840.js';
...
### Sanitization
```javascript
import { sanitizeEmail } from './email-validation-pr840.js';
